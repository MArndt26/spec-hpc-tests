...
extern MPI_Offset    att_len[NVARS][MAX_NATTS];
extern MPI_Offset    gatt_len[NGATTS];
...
extern int
toMixedBase(MPI_Offset number, int length, const MPI_Offset *base, MPI_Offset *result);

extern MPI_Offset
fromMixedBase(int length, MPI_Offset *number, MPI_Offset *base);
...
extern text hash_text(const int cdf_format, const nc_type type,
       const int rank, const MPI_Offset *index, const nct_itype itype);
extern schar hash_schar(const int cdf_format, const nc_type type,
       const int rank, const MPI_Offset *index, const nct_itype itype);
extern uchar hash_uchar(const int cdf_format, const nc_type type,
       const int rank, const MPI_Offset *index, const nct_itype itype);
extern short hash_short(const int cdf_format, const nc_type type,
       const int rank, const MPI_Offset *index, const nct_itype itype);
extern ushort hash_ushort(const int cdf_format, const nc_type type,
       const int rank, const MPI_Offset *index, const nct_itype itype);
extern int hash_int(const int cdf_format, const nc_type type,
       const int rank, const MPI_Offset *index, const nct_itype itype);
extern uint hash_uint(const int cdf_format, const nc_type type,
       const int rank, const MPI_Offset *index, const nct_itype itype);
extern long hash_long(const int cdf_format, const nc_type type,
       const int rank, const MPI_Offset *index, const nct_itype itype);
extern float hash_float(const int cdf_format, const nc_type type,
       const int rank, const MPI_Offset *index, const nct_itype itype);
extern double hash_double(const int cdf_format, const nc_type type,
       const int rank, const MPI_Offset *index, const nct_itype itype);
extern longlong hash_longlong(const int cdf_format, const nc_type type,
       const int rank, const MPI_Offset *index, const nct_itype itype);
extern ulonglong hash_ulonglong(const int cdf_format, const nc_type type,
       const int rank, const MPI_Offset *index, const nct_itype itype);

extern int check_vars_text(const char *filename, int numVars);
extern int check_vars_schar(const char *filename, int numVars);
extern int check_vars_uchar(const char *filename, int numVars);
extern int check_vars_short(const char *filename, int numVars);
extern int check_vars_ushort(const char *filename, int numVars);
extern int check_vars_int(const char *filename, int numVars);
extern int check_vars_uint(const char *filename, int numVars);
extern int check_vars_long(const char *filename, int numVars);
extern int check_vars_float(const char *filename, int numVars);
extern int check_vars_double(const char *filename, int numVars);
extern int check_vars_longlong(const char *filename, int numVars);
extern int check_vars_ulonglong(const char *filename, int numVars);

extern int check_atts_text(int ncid, int numGatts, int numVars);
extern int check_atts_schar(int ncid, int numGatts, int numVars);
extern int check_atts_uchar(int ncid, int numGatts, int numVars);
extern int check_atts_short(int ncid, int numGatts, int numVars);
extern int check_atts_ushort(int ncid, int numGatts, int numVars);
extern int check_atts_int(int ncid, int numGatts, int numVars);
extern int check_atts_uint(int ncid, int numGatts, int numVars);
extern int check_atts_long(int ncid, int numGatts, int numVars);
extern int check_atts_float(int ncid, int numGatts, int numVars);
extern int check_atts_double(int ncid, int numGatts, int numVars);
extern int check_atts_longlong(int ncid, int numGatts, int numVars);
extern int check_atts_ulonglong(int ncid, int numGatts, int numVars);
