...
int test_column_wise_text(char *filename, int cdf)
{
    ...
    err = ncmpi_put_vara_text_all(ncid, varid, start, count, buf[0]); CHECK_ERR
    free(buf[0]);
...
int test_column_wise_schar(char *filename, int cdf)
{
    ...
    start[0] = 0;   start[1] = myOff;
    count[0] = NY;  count[1] = myNX;
    err = ncmpi_put_vara_schar_all(ncid, varid, start, count, buf[0]); CHECK_ERR
    free(buf[0]);
...
int test_column_wise_uchar(char *filename, int cdf)
{
    ...
    start[0] = 0;   start[1] = myOff;
    count[0] = NY;  count[1] = myNX;
    err = ncmpi_put_vara_uchar_all(ncid, varid, start, count, buf[0]); CHECK_ERR
    free(buf[0]);
...
int test_column_wise_short(char *filename, int cdf)
{
    ...
    start[0] = 0;   start[1] = myOff;
    count[0] = NY;  count[1] = myNX;
    err = ncmpi_put_vara_short_all(ncid, varid, start, count, buf[0]); CHECK_ERR
    free(buf[0]);
...
int test_column_wise_ushort(char *filename, int cdf)
{
    ...
    start[0] = 0;   start[1] = myOff;
    count[0] = NY;  count[1] = myNX;
    err = ncmpi_put_vara_ushort_all(ncid, varid, start, count, buf[0]); CHECK_ERR
    free(buf[0]);
...
int test_column_wise_int(char *filename, int cdf)
{
    ...
    start[0] = 0;   start[1] = myOff;
    count[0] = NY;  count[1] = myNX;
    err = ncmpi_put_vara_int_all(ncid, varid, start, count, buf[0]); CHECK_ERR
    free(buf[0]);
...
int test_column_wise_uint(char *filename, int cdf)
{
    ...
    start[0] = 0;   start[1] = myOff;
    count[0] = NY;  count[1] = myNX;
    err = ncmpi_put_vara_uint_all(ncid, varid, start, count, buf[0]); CHECK_ERR
    free(buf[0]);
...
int test_column_wise_float(char *filename, int cdf)
{
    ...
    start[0] = 0;   start[1] = myOff;
    count[0] = NY;  count[1] = myNX;
    err = ncmpi_put_vara_float_all(ncid, varid, start, count, buf[0]); CHECK_ERR
    free(buf[0]);
...
int test_column_wise_double(char *filename, int cdf)
{
    ...
    start[0] = 0;   start[1] = myOff;
    count[0] = NY;  count[1] = myNX;
    err = ncmpi_put_vara_double_all(ncid, varid, start, count, buf[0]); CHECK_ERR
    free(buf[0]);
...
int test_column_wise_longlong(char *filename, int cdf)
{
    ...
    start[0] = 0;   start[1] = myOff;
    count[0] = NY;  count[1] = myNX;
    err = ncmpi_put_vara_longlong_all(ncid, varid, start, count, buf[0]); CHECK_ERR
    free(buf[0]);
...
int test_column_wise_ulonglong(char *filename, int cdf)
{
    ...
    start[0] = 0;   start[1] = myOff;
    count[0] = NY;  count[1] = myNX;
    err = ncmpi_put_vara_ulonglong_all(ncid, varid, start, count, buf[0]); CHECK_ERR
    free(buf[0]);
