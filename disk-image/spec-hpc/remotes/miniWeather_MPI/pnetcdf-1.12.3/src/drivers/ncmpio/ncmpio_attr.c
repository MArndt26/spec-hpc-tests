           ...
           schar *buf)
{
    switch(xtype) {
        ...
        case NC_BYTE:
            return ncmpix_pad_getn_NC_BYTE_schar  (xp, nelems, buf);
        case NC_UBYTE:
            return ncmpix_pad_getn_NC_UBYTE_schar (xp, nelems, buf);
        case NC_SHORT:
            return ncmpix_pad_getn_NC_SHORT_schar (xp, nelems, buf);
        case NC_USHORT:
            return ncmpix_pad_getn_NC_USHORT_schar(xp, nelems, buf);
        case NC_INT:
            return ncmpix_getn_NC_INT_schar       (xp, nelems, buf);
        case NC_UINT:
            return ncmpix_getn_NC_UINT_schar      (xp, nelems, buf);
        case NC_FLOAT:
            return ncmpix_getn_NC_FLOAT_schar     (xp, nelems, buf);
        case NC_DOUBLE:
            return ncmpix_getn_NC_DOUBLE_schar    (xp, nelems, buf);
        case NC_INT64:
            return ncmpix_getn_NC_INT64_schar     (xp, nelems, buf);
        case NC_UINT64:
            return ncmpix_getn_NC_UINT64_schar    (xp, nelems, buf);
        default:
           ...
           uchar *buf)
{
    switch(xtype) {
        /* possible error returned of this switch block is NC_ERANGE */
        case NC_BYTE:
            return ncmpix_pad_getn_NC_BYTE_uchar  (xp, nelems, buf);
        case NC_UBYTE:
            return ncmpix_pad_getn_NC_UBYTE_uchar (xp, nelems, buf);
        case NC_SHORT:
            return ncmpix_pad_getn_NC_SHORT_uchar (xp, nelems, buf);
        case NC_USHORT:
            return ncmpix_pad_getn_NC_USHORT_uchar(xp, nelems, buf);
        case NC_INT:
            return ncmpix_getn_NC_INT_uchar       (xp, nelems, buf);
        case NC_UINT:
            return ncmpix_getn_NC_UINT_uchar      (xp, nelems, buf);
        case NC_FLOAT:
            return ncmpix_getn_NC_FLOAT_uchar     (xp, nelems, buf);
        case NC_DOUBLE:
            return ncmpix_getn_NC_DOUBLE_uchar    (xp, nelems, buf);
        case NC_INT64:
            return ncmpix_getn_NC_INT64_uchar     (xp, nelems, buf);
        case NC_UINT64:
            return ncmpix_getn_NC_UINT64_uchar    (xp, nelems, buf);
        default:
            /* this error is unlikely, but an internal error if happened */
            fprintf(stderr, "Error: bad attrp->xtype(%d) in %s\n",
                    xtype,__func__);
           ...
           short *buf)
{
    switch(xtype) {
        /* possible error returned of this switch block is NC_ERANGE */
        case NC_BYTE:
            return ncmpix_pad_getn_NC_BYTE_short  (xp, nelems, buf);
        case NC_UBYTE:
            return ncmpix_pad_getn_NC_UBYTE_short (xp, nelems, buf);
        case NC_SHORT:
            return ncmpix_pad_getn_NC_SHORT_short (xp, nelems, buf);
        case NC_USHORT:
            return ncmpix_pad_getn_NC_USHORT_short(xp, nelems, buf);
        case NC_INT:
            return ncmpix_getn_NC_INT_short       (xp, nelems, buf);
        case NC_UINT:
            return ncmpix_getn_NC_UINT_short      (xp, nelems, buf);
        case NC_FLOAT:
            return ncmpix_getn_NC_FLOAT_short     (xp, nelems, buf);
        case NC_DOUBLE:
            return ncmpix_getn_NC_DOUBLE_short    (xp, nelems, buf);
        case NC_INT64:
            return ncmpix_getn_NC_INT64_short     (xp, nelems, buf);
        case NC_UINT64:
            return ncmpix_getn_NC_UINT64_short    (xp, nelems, buf);
        default:
            /* this error is unlikely, but an internal error if happened */
            fprintf(stderr, "Error: bad attrp->xtype(%d) in %s\n",
                    xtype,__func__);
           ...
           ushort *buf)
{
    switch(xtype) {
        /* possible error returned of this switch block is NC_ERANGE */
        case NC_BYTE:
            return ncmpix_pad_getn_NC_BYTE_ushort  (xp, nelems, buf);
        case NC_UBYTE:
            return ncmpix_pad_getn_NC_UBYTE_ushort (xp, nelems, buf);
        case NC_SHORT:
            return ncmpix_pad_getn_NC_SHORT_ushort (xp, nelems, buf);
        case NC_USHORT:
            return ncmpix_pad_getn_NC_USHORT_ushort(xp, nelems, buf);
        case NC_INT:
            return ncmpix_getn_NC_INT_ushort       (xp, nelems, buf);
        case NC_UINT:
            return ncmpix_getn_NC_UINT_ushort      (xp, nelems, buf);
        case NC_FLOAT:
            return ncmpix_getn_NC_FLOAT_ushort     (xp, nelems, buf);
        case NC_DOUBLE:
            return ncmpix_getn_NC_DOUBLE_ushort    (xp, nelems, buf);
        case NC_INT64:
            return ncmpix_getn_NC_INT64_ushort     (xp, nelems, buf);
        case NC_UINT64:
            return ncmpix_getn_NC_UINT64_ushort    (xp, nelems, buf);
        default:
            /* this error is unlikely, but an internal error if happened */
            fprintf(stderr, "Error: bad attrp->xtype(%d) in %s\n",
                    xtype,__func__);
           ...
           int *buf)
{
    switch(xtype) {
        /* possible error returned of this switch block is NC_ERANGE */
        case NC_BYTE:
            return ncmpix_pad_getn_NC_BYTE_int  (xp, nelems, buf);
        case NC_UBYTE:
            return ncmpix_pad_getn_NC_UBYTE_int (xp, nelems, buf);
        case NC_SHORT:
            return ncmpix_pad_getn_NC_SHORT_int (xp, nelems, buf);
        case NC_USHORT:
            return ncmpix_pad_getn_NC_USHORT_int(xp, nelems, buf);
        case NC_INT:
            return ncmpix_getn_NC_INT_int       (xp, nelems, buf);
        case NC_UINT:
            return ncmpix_getn_NC_UINT_int      (xp, nelems, buf);
        case NC_FLOAT:
            return ncmpix_getn_NC_FLOAT_int     (xp, nelems, buf);
        case NC_DOUBLE:
            return ncmpix_getn_NC_DOUBLE_int    (xp, nelems, buf);
        case NC_INT64:
            return ncmpix_getn_NC_INT64_int     (xp, nelems, buf);
        case NC_UINT64:
            return ncmpix_getn_NC_UINT64_int    (xp, nelems, buf);
        default:
            /* this error is unlikely, but an internal error if happened */
            fprintf(stderr, "Error: bad attrp->xtype(%d) in %s\n",
                    xtype,__func__);
           ...
           uint *buf)
{
    switch(xtype) {
        /* possible error returned of this switch block is NC_ERANGE */
        case NC_BYTE:
            return ncmpix_pad_getn_NC_BYTE_uint  (xp, nelems, buf);
        case NC_UBYTE:
            return ncmpix_pad_getn_NC_UBYTE_uint (xp, nelems, buf);
        case NC_SHORT:
            return ncmpix_pad_getn_NC_SHORT_uint (xp, nelems, buf);
        case NC_USHORT:
            return ncmpix_pad_getn_NC_USHORT_uint(xp, nelems, buf);
        case NC_INT:
            return ncmpix_getn_NC_INT_uint       (xp, nelems, buf);
        case NC_UINT:
            return ncmpix_getn_NC_UINT_uint      (xp, nelems, buf);
        case NC_FLOAT:
            return ncmpix_getn_NC_FLOAT_uint     (xp, nelems, buf);
        case NC_DOUBLE:
            return ncmpix_getn_NC_DOUBLE_uint    (xp, nelems, buf);
        case NC_INT64:
            return ncmpix_getn_NC_INT64_uint     (xp, nelems, buf);
        case NC_UINT64:
            return ncmpix_getn_NC_UINT64_uint    (xp, nelems, buf);
        default:
            /* this error is unlikely, but an internal error if happened */
            fprintf(stderr, "Error: bad attrp->xtype(%d) in %s\n",
                    xtype,__func__);
           ...
           float *buf)
{
    switch(xtype) {
        /* possible error returned of this switch block is NC_ERANGE */
        case NC_BYTE:
            return ncmpix_pad_getn_NC_BYTE_float  (xp, nelems, buf);
        case NC_UBYTE:
            return ncmpix_pad_getn_NC_UBYTE_float (xp, nelems, buf);
        case NC_SHORT:
            return ncmpix_pad_getn_NC_SHORT_float (xp, nelems, buf);
        case NC_USHORT:
            return ncmpix_pad_getn_NC_USHORT_float(xp, nelems, buf);
        case NC_INT:
            return ncmpix_getn_NC_INT_float       (xp, nelems, buf);
        case NC_UINT:
            return ncmpix_getn_NC_UINT_float      (xp, nelems, buf);
        case NC_FLOAT:
            return ncmpix_getn_NC_FLOAT_float     (xp, nelems, buf);
        case NC_DOUBLE:
            return ncmpix_getn_NC_DOUBLE_float    (xp, nelems, buf);
        case NC_INT64:
            return ncmpix_getn_NC_INT64_float     (xp, nelems, buf);
        case NC_UINT64:
            return ncmpix_getn_NC_UINT64_float    (xp, nelems, buf);
        default:
            /* this error is unlikely, but an internal error if happened */
            fprintf(stderr, "Error: bad attrp->xtype(%d) in %s\n",
                    xtype,__func__);
           ...
           double *buf)
{
    switch(xtype) {
        /* possible error returned of this switch block is NC_ERANGE */
        case NC_BYTE:
            return ncmpix_pad_getn_NC_BYTE_double  (xp, nelems, buf);
        case NC_UBYTE:
            return ncmpix_pad_getn_NC_UBYTE_double (xp, nelems, buf);
        case NC_SHORT:
            return ncmpix_pad_getn_NC_SHORT_double (xp, nelems, buf);
        case NC_USHORT:
            return ncmpix_pad_getn_NC_USHORT_double(xp, nelems, buf);
        case NC_INT:
            return ncmpix_getn_NC_INT_double       (xp, nelems, buf);
        case NC_UINT:
            return ncmpix_getn_NC_UINT_double      (xp, nelems, buf);
        case NC_FLOAT:
            return ncmpix_getn_NC_FLOAT_double     (xp, nelems, buf);
        case NC_DOUBLE:
            return ncmpix_getn_NC_DOUBLE_double    (xp, nelems, buf);
        case NC_INT64:
            return ncmpix_getn_NC_INT64_double     (xp, nelems, buf);
        case NC_UINT64:
            return ncmpix_getn_NC_UINT64_double    (xp, nelems, buf);
        default:
            /* this error is unlikely, but an internal error if happened */
            fprintf(stderr, "Error: bad attrp->xtype(%d) in %s\n",
                    xtype,__func__);
...
/* This is an independent subroutine */
static int
get_att_longlong(nc_type       xtype,
           const void  **xp,
           MPI_Offset    nelems,
           long long *buf)
{
    switch(xtype) {
        /* possible error returned of this switch block is NC_ERANGE */
        case NC_BYTE:
            return ncmpix_pad_getn_NC_BYTE_longlong  (xp, nelems, buf);
        case NC_UBYTE:
            return ncmpix_pad_getn_NC_UBYTE_longlong (xp, nelems, buf);
        case NC_SHORT:
            return ncmpix_pad_getn_NC_SHORT_longlong (xp, nelems, buf);
        case NC_USHORT:
            return ncmpix_pad_getn_NC_USHORT_longlong(xp, nelems, buf);
        case NC_INT:
            return ncmpix_getn_NC_INT_longlong       (xp, nelems, buf);
        case NC_UINT:
            return ncmpix_getn_NC_UINT_longlong      (xp, nelems, buf);
        case NC_FLOAT:
            return ncmpix_getn_NC_FLOAT_longlong     (xp, nelems, buf);
        case NC_DOUBLE:
            return ncmpix_getn_NC_DOUBLE_longlong    (xp, nelems, buf);
        case NC_INT64:
            return ncmpix_getn_NC_INT64_longlong     (xp, nelems, buf);
        case NC_UINT64:
            return ncmpix_getn_NC_UINT64_longlong    (xp, nelems, buf);
        default:
            /* this error is unlikely, but an internal error if happened */
            fprintf(stderr, "Error: bad attrp->xtype(%d) in %s\n",
                    xtype,__func__);
...
/* This is an independent subroutine */
static int
get_att_ulonglong(nc_type       xtype,
           const void  **xp,
           MPI_Offset    nelems,
           unsigned long long *buf)
{
    switch(xtype) {
        /* possible error returned of this switch block is NC_ERANGE */
        case NC_BYTE:
            return ncmpix_pad_getn_NC_BYTE_ulonglong  (xp, nelems, buf);
        case NC_UBYTE:
            return ncmpix_pad_getn_NC_UBYTE_ulonglong (xp, nelems, buf);
        case NC_SHORT:
            return ncmpix_pad_getn_NC_SHORT_ulonglong (xp, nelems, buf);
        case NC_USHORT:
            return ncmpix_pad_getn_NC_USHORT_ulonglong(xp, nelems, buf);
        case NC_INT:
            return ncmpix_getn_NC_INT_ulonglong       (xp, nelems, buf);
        case NC_UINT:
            return ncmpix_getn_NC_UINT_ulonglong      (xp, nelems, buf);
        case NC_FLOAT:
            return ncmpix_getn_NC_FLOAT_ulonglong     (xp, nelems, buf);
        case NC_DOUBLE:
            return ncmpix_getn_NC_DOUBLE_ulonglong    (xp, nelems, buf);
        case NC_INT64:
            return ncmpix_getn_NC_INT64_ulonglong     (xp, nelems, buf);
        case NC_UINT64:
            return ncmpix_getn_NC_UINT64_ulonglong    (xp, nelems, buf);
        default:
            /* this error is unlikely, but an internal error if happened */
            fprintf(stderr, "Error: bad attrp->xtype(%d) in %s\n",
                    xtype,__func__);
...
static int
putn_schar(void       **xpp,    /* buffer to be written to file */
        MPI_Offset   nelems, /* no. elements in user buffer */
        const schar    *buf,    /* user buffer of type schar */
        nc_type      xtype,  /* external NC type */
        void        *fillp)  /* fill value in internal representation */
{
    switch(xtype) {
        case NC_BYTE:
            return ncmpix_pad_putn_NC_BYTE_schar  (xpp, nelems, buf, fillp);
        case NC_UBYTE:
            return ncmpix_pad_putn_NC_UBYTE_schar (xpp, nelems, buf, fillp);
        case NC_SHORT:
            return ncmpix_pad_putn_NC_SHORT_schar (xpp, nelems, buf, fillp);
        case NC_USHORT:
            return ncmpix_pad_putn_NC_USHORT_schar(xpp, nelems, buf, fillp);
        case NC_INT:
            return ncmpix_putn_NC_INT_schar       (xpp, nelems, buf, fillp);
        case NC_UINT:
            return ncmpix_putn_NC_UINT_schar      (xpp, nelems, buf, fillp);
        case NC_FLOAT:
            return ncmpix_putn_NC_FLOAT_schar     (xpp, nelems, buf, fillp);
        case NC_DOUBLE:
            return ncmpix_putn_NC_DOUBLE_schar    (xpp, nelems, buf, fillp);
        case NC_INT64:
            return ncmpix_putn_NC_INT64_schar     (xpp, nelems, buf, fillp);
        case NC_UINT64:
            return ncmpix_putn_NC_UINT64_schar    (xpp, nelems, buf, fillp);
        case NC_CHAR:
...
/* This is a collective subroutine */
static int
putn_uchar(void       **xpp,    /* buffer to be written to file */
        MPI_Offset   nelems, /* no. elements in user buffer */
        const uchar    *buf,    /* user buffer of type uchar */
        nc_type      xtype,  /* external NC type */
        void        *fillp)  /* fill value in internal representation */
{
    switch(xtype) {
        case NC_BYTE:
            return ncmpix_pad_putn_NC_BYTE_uchar  (xpp, nelems, buf, fillp);
        case NC_UBYTE:
            return ncmpix_pad_putn_NC_UBYTE_uchar (xpp, nelems, buf, fillp);
        case NC_SHORT:
            return ncmpix_pad_putn_NC_SHORT_uchar (xpp, nelems, buf, fillp);
        case NC_USHORT:
            return ncmpix_pad_putn_NC_USHORT_uchar(xpp, nelems, buf, fillp);
        case NC_INT:
            return ncmpix_putn_NC_INT_uchar       (xpp, nelems, buf, fillp);
        case NC_UINT:
            return ncmpix_putn_NC_UINT_uchar      (xpp, nelems, buf, fillp);
        case NC_FLOAT:
            return ncmpix_putn_NC_FLOAT_uchar     (xpp, nelems, buf, fillp);
        case NC_DOUBLE:
            return ncmpix_putn_NC_DOUBLE_uchar    (xpp, nelems, buf, fillp);
        case NC_INT64:
            return ncmpix_putn_NC_INT64_uchar     (xpp, nelems, buf, fillp);
        case NC_UINT64:
            return ncmpix_putn_NC_UINT64_uchar    (xpp, nelems, buf, fillp);
        case NC_CHAR:
            return NC_ECHAR; /* NC_ECHAR check is done earlier */
        default: fprintf(stderr, "Error: bad xtype(%d) in %s\n",xtype,__func__);
            return NC_EBADTYPE;
...
/* This is a collective subroutine */
static int
putn_short(void       **xpp,    /* buffer to be written to file */
        MPI_Offset   nelems, /* no. elements in user buffer */
        const short    *buf,    /* user buffer of type short */
        nc_type      xtype,  /* external NC type */
        void        *fillp)  /* fill value in internal representation */
{
    switch(xtype) {
        case NC_BYTE:
            return ncmpix_pad_putn_NC_BYTE_short  (xpp, nelems, buf, fillp);
        case NC_UBYTE:
            return ncmpix_pad_putn_NC_UBYTE_short (xpp, nelems, buf, fillp);
        case NC_SHORT:
            return ncmpix_pad_putn_NC_SHORT_short (xpp, nelems, buf, fillp);
        case NC_USHORT:
            return ncmpix_pad_putn_NC_USHORT_short(xpp, nelems, buf, fillp);
        case NC_INT:
            return ncmpix_putn_NC_INT_short       (xpp, nelems, buf, fillp);
        case NC_UINT:
            return ncmpix_putn_NC_UINT_short      (xpp, nelems, buf, fillp);
        case NC_FLOAT:
            return ncmpix_putn_NC_FLOAT_short     (xpp, nelems, buf, fillp);
        case NC_DOUBLE:
            return ncmpix_putn_NC_DOUBLE_short    (xpp, nelems, buf, fillp);
        case NC_INT64:
            return ncmpix_putn_NC_INT64_short     (xpp, nelems, buf, fillp);
        case NC_UINT64:
            return ncmpix_putn_NC_UINT64_short    (xpp, nelems, buf, fillp);
        case NC_CHAR:
            return NC_ECHAR; /* NC_ECHAR check is done earlier */
        default: fprintf(stderr, "Error: bad xtype(%d) in %s\n",xtype,__func__);
            return NC_EBADTYPE;
...
/* This is a collective subroutine */
static int
putn_ushort(void       **xpp,    /* buffer to be written to file */
        MPI_Offset   nelems, /* no. elements in user buffer */
        const ushort    *buf,    /* user buffer of type ushort */
        nc_type      xtype,  /* external NC type */
        void        *fillp)  /* fill value in internal representation */
{
    switch(xtype) {
        case NC_BYTE:
            return ncmpix_pad_putn_NC_BYTE_ushort  (xpp, nelems, buf, fillp);
        case NC_UBYTE:
            return ncmpix_pad_putn_NC_UBYTE_ushort (xpp, nelems, buf, fillp);
        case NC_SHORT:
            return ncmpix_pad_putn_NC_SHORT_ushort (xpp, nelems, buf, fillp);
        case NC_USHORT:
            return ncmpix_pad_putn_NC_USHORT_ushort(xpp, nelems, buf, fillp);
        case NC_INT:
            return ncmpix_putn_NC_INT_ushort       (xpp, nelems, buf, fillp);
        case NC_UINT:
            return ncmpix_putn_NC_UINT_ushort      (xpp, nelems, buf, fillp);
        case NC_FLOAT:
            return ncmpix_putn_NC_FLOAT_ushort     (xpp, nelems, buf, fillp);
        case NC_DOUBLE:
            return ncmpix_putn_NC_DOUBLE_ushort    (xpp, nelems, buf, fillp);
        case NC_INT64:
            return ncmpix_putn_NC_INT64_ushort     (xpp, nelems, buf, fillp);
        case NC_UINT64:
            return ncmpix_putn_NC_UINT64_ushort    (xpp, nelems, buf, fillp);
        case NC_CHAR:
            return NC_ECHAR; /* NC_ECHAR check is done earlier */
        default: fprintf(stderr, "Error: bad xtype(%d) in %s\n",xtype,__func__);
            return NC_EBADTYPE;
...
/* This is a collective subroutine */
static int
putn_int(void       **xpp,    /* buffer to be written to file */
        MPI_Offset   nelems, /* no. elements in user buffer */
        const int    *buf,    /* user buffer of type int */
        nc_type      xtype,  /* external NC type */
        void        *fillp)  /* fill value in internal representation */
{
    switch(xtype) {
        case NC_BYTE:
            return ncmpix_pad_putn_NC_BYTE_int  (xpp, nelems, buf, fillp);
        case NC_UBYTE:
            return ncmpix_pad_putn_NC_UBYTE_int (xpp, nelems, buf, fillp);
        case NC_SHORT:
            return ncmpix_pad_putn_NC_SHORT_int (xpp, nelems, buf, fillp);
        case NC_USHORT:
            return ncmpix_pad_putn_NC_USHORT_int(xpp, nelems, buf, fillp);
        case NC_INT:
            return ncmpix_putn_NC_INT_int       (xpp, nelems, buf, fillp);
        case NC_UINT:
            return ncmpix_putn_NC_UINT_int      (xpp, nelems, buf, fillp);
        case NC_FLOAT:
            return ncmpix_putn_NC_FLOAT_int     (xpp, nelems, buf, fillp);
        case NC_DOUBLE:
            return ncmpix_putn_NC_DOUBLE_int    (xpp, nelems, buf, fillp);
        case NC_INT64:
            return ncmpix_putn_NC_INT64_int     (xpp, nelems, buf, fillp);
        case NC_UINT64:
            return ncmpix_putn_NC_UINT64_int    (xpp, nelems, buf, fillp);
        case NC_CHAR:
            return NC_ECHAR; /* NC_ECHAR check is done earlier */
        default: fprintf(stderr, "Error: bad xtype(%d) in %s\n",xtype,__func__);
            return NC_EBADTYPE;
...
/* This is a collective subroutine */
static int
putn_uint(void       **xpp,    /* buffer to be written to file */
        MPI_Offset   nelems, /* no. elements in user buffer */
        const uint    *buf,    /* user buffer of type uint */
        nc_type      xtype,  /* external NC type */
        void        *fillp)  /* fill value in internal representation */
{
    switch(xtype) {
        case NC_BYTE:
            return ncmpix_pad_putn_NC_BYTE_uint  (xpp, nelems, buf, fillp);
        case NC_UBYTE:
            return ncmpix_pad_putn_NC_UBYTE_uint (xpp, nelems, buf, fillp);
        case NC_SHORT:
            return ncmpix_pad_putn_NC_SHORT_uint (xpp, nelems, buf, fillp);
        case NC_USHORT:
            return ncmpix_pad_putn_NC_USHORT_uint(xpp, nelems, buf, fillp);
        case NC_INT:
            return ncmpix_putn_NC_INT_uint       (xpp, nelems, buf, fillp);
        case NC_UINT:
            return ncmpix_putn_NC_UINT_uint      (xpp, nelems, buf, fillp);
        case NC_FLOAT:
            return ncmpix_putn_NC_FLOAT_uint     (xpp, nelems, buf, fillp);
        case NC_DOUBLE:
            return ncmpix_putn_NC_DOUBLE_uint    (xpp, nelems, buf, fillp);
        case NC_INT64:
            return ncmpix_putn_NC_INT64_uint     (xpp, nelems, buf, fillp);
        case NC_UINT64:
            return ncmpix_putn_NC_UINT64_uint    (xpp, nelems, buf, fillp);
        case NC_CHAR:
            return NC_ECHAR; /* NC_ECHAR check is done earlier */
        default: fprintf(stderr, "Error: bad xtype(%d) in %s\n",xtype,__func__);
            return NC_EBADTYPE;
...
/* This is a collective subroutine */
static int
putn_float(void       **xpp,    /* buffer to be written to file */
        MPI_Offset   nelems, /* no. elements in user buffer */
        const float    *buf,    /* user buffer of type float */
        nc_type      xtype,  /* external NC type */
        void        *fillp)  /* fill value in internal representation */
{
    switch(xtype) {
        case NC_BYTE:
            return ncmpix_pad_putn_NC_BYTE_float  (xpp, nelems, buf, fillp);
        case NC_UBYTE:
            return ncmpix_pad_putn_NC_UBYTE_float (xpp, nelems, buf, fillp);
        case NC_SHORT:
            return ncmpix_pad_putn_NC_SHORT_float (xpp, nelems, buf, fillp);
        case NC_USHORT:
            return ncmpix_pad_putn_NC_USHORT_float(xpp, nelems, buf, fillp);
        case NC_INT:
            return ncmpix_putn_NC_INT_float       (xpp, nelems, buf, fillp);
        case NC_UINT:
            return ncmpix_putn_NC_UINT_float      (xpp, nelems, buf, fillp);
        case NC_FLOAT:
            return ncmpix_putn_NC_FLOAT_float     (xpp, nelems, buf, fillp);
        case NC_DOUBLE:
            return ncmpix_putn_NC_DOUBLE_float    (xpp, nelems, buf, fillp);
        case NC_INT64:
            return ncmpix_putn_NC_INT64_float     (xpp, nelems, buf, fillp);
        case NC_UINT64:
            return ncmpix_putn_NC_UINT64_float    (xpp, nelems, buf, fillp);
        case NC_CHAR:
            return NC_ECHAR; /* NC_ECHAR check is done earlier */
        default: fprintf(stderr, "Error: bad xtype(%d) in %s\n",xtype,__func__);
            return NC_EBADTYPE;
...
/* This is a collective subroutine */
static int
putn_double(void       **xpp,    /* buffer to be written to file */
        MPI_Offset   nelems, /* no. elements in user buffer */
        const double    *buf,    /* user buffer of type double */
        nc_type      xtype,  /* external NC type */
        void        *fillp)  /* fill value in internal representation */
{
    switch(xtype) {
        case NC_BYTE:
            return ncmpix_pad_putn_NC_BYTE_double  (xpp, nelems, buf, fillp);
        case NC_UBYTE:
            return ncmpix_pad_putn_NC_UBYTE_double (xpp, nelems, buf, fillp);
        case NC_SHORT:
            return ncmpix_pad_putn_NC_SHORT_double (xpp, nelems, buf, fillp);
        case NC_USHORT:
            return ncmpix_pad_putn_NC_USHORT_double(xpp, nelems, buf, fillp);
        case NC_INT:
            return ncmpix_putn_NC_INT_double       (xpp, nelems, buf, fillp);
        case NC_UINT:
            return ncmpix_putn_NC_UINT_double      (xpp, nelems, buf, fillp);
        case NC_FLOAT:
            return ncmpix_putn_NC_FLOAT_double     (xpp, nelems, buf, fillp);
        case NC_DOUBLE:
            return ncmpix_putn_NC_DOUBLE_double    (xpp, nelems, buf, fillp);
        case NC_INT64:
            return ncmpix_putn_NC_INT64_double     (xpp, nelems, buf, fillp);
        case NC_UINT64:
            return ncmpix_putn_NC_UINT64_double    (xpp, nelems, buf, fillp);
        case NC_CHAR:
            return NC_ECHAR; /* NC_ECHAR check is done earlier */
        default: fprintf(stderr, "Error: bad xtype(%d) in %s\n",xtype,__func__);
            return NC_EBADTYPE;
...
/* This is a collective subroutine */
static int
putn_longlong(void       **xpp,    /* buffer to be written to file */
        MPI_Offset   nelems, /* no. elements in user buffer */
        const longlong    *buf,    /* user buffer of type longlong */
        nc_type      xtype,  /* external NC type */
        void        *fillp)  /* fill value in internal representation */
{
    switch(xtype) {
        case NC_BYTE:
            return ncmpix_pad_putn_NC_BYTE_longlong  (xpp, nelems, buf, fillp);
        case NC_UBYTE:
            return ncmpix_pad_putn_NC_UBYTE_longlong (xpp, nelems, buf, fillp);
        case NC_SHORT:
            return ncmpix_pad_putn_NC_SHORT_longlong (xpp, nelems, buf, fillp);
        case NC_USHORT:
            return ncmpix_pad_putn_NC_USHORT_longlong(xpp, nelems, buf, fillp);
        case NC_INT:
            return ncmpix_putn_NC_INT_longlong       (xpp, nelems, buf, fillp);
        case NC_UINT:
            return ncmpix_putn_NC_UINT_longlong      (xpp, nelems, buf, fillp);
        case NC_FLOAT:
            return ncmpix_putn_NC_FLOAT_longlong     (xpp, nelems, buf, fillp);
        case NC_DOUBLE:
            return ncmpix_putn_NC_DOUBLE_longlong    (xpp, nelems, buf, fillp);
        case NC_INT64:
            return ncmpix_putn_NC_INT64_longlong     (xpp, nelems, buf, fillp);
        case NC_UINT64:
            return ncmpix_putn_NC_UINT64_longlong    (xpp, nelems, buf, fillp);
        case NC_CHAR:
            return NC_ECHAR; /* NC_ECHAR check is done earlier */
        default: fprintf(stderr, "Error: bad xtype(%d) in %s\n",xtype,__func__);
            return NC_EBADTYPE;
...
/* This is a collective subroutine */
static int
putn_ulonglong(void       **xpp,    /* buffer to be written to file */
        MPI_Offset   nelems, /* no. elements in user buffer */
        const ulonglong    *buf,    /* user buffer of type ulonglong */
        nc_type      xtype,  /* external NC type */
        void        *fillp)  /* fill value in internal representation */
{
    switch(xtype) {
        case NC_BYTE:
            return ncmpix_pad_putn_NC_BYTE_ulonglong  (xpp, nelems, buf, fillp);
        case NC_UBYTE:
            return ncmpix_pad_putn_NC_UBYTE_ulonglong (xpp, nelems, buf, fillp);
        case NC_SHORT:
            return ncmpix_pad_putn_NC_SHORT_ulonglong (xpp, nelems, buf, fillp);
        case NC_USHORT:
            return ncmpix_pad_putn_NC_USHORT_ulonglong(xpp, nelems, buf, fillp);
        case NC_INT:
            return ncmpix_putn_NC_INT_ulonglong       (xpp, nelems, buf, fillp);
        case NC_UINT:
            return ncmpix_putn_NC_UINT_ulonglong      (xpp, nelems, buf, fillp);
        case NC_FLOAT:
            return ncmpix_putn_NC_FLOAT_ulonglong     (xpp, nelems, buf, fillp);
        case NC_DOUBLE:
            return ncmpix_putn_NC_DOUBLE_ulonglong    (xpp, nelems, buf, fillp);
        case NC_INT64:
            return ncmpix_putn_NC_INT64_ulonglong     (xpp, nelems, buf, fillp);
        case NC_UINT64:
            return ncmpix_putn_NC_UINT64_ulonglong    (xpp, nelems, buf, fillp);
        case NC_CHAR:
            return NC_ECHAR; /* NC_ECHAR check is done earlier */
        default: fprintf(stderr, "Error: bad xtype(%d) in %s\n",xtype,__func__);
            return NC_EBADTYPE;
